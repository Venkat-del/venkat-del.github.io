    ...
    */
    ...
    lib.Parent = function(id, url, config) {
        ...
        this._constructIframe = function() {
            ...
            //DUPress modifications for allowing fullscreen, added 20th Jan 2016
            this.iframe.setAttribute('allowfullscreen', 'true');
            this.iframe.setAttribute('webkitallowfullscreen', 'true');
            this.iframe.setAttribute('mozallowfullscreen', 'true');
            this.iframe.setAttribute('oallowfullscreen', 'true');
    ...
    lib.Child = function(config) {
        ...
        this.sendHeight = function() {
            ...
            if(document.getElementById('player') ){
                //Alok: To make the video iframe resize down when scaling the page down!
                var height = document.getElementById('player').offsetHeight.toString();
            }else{
